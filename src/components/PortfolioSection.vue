...
const projects = [
  ...
  {
    id: 3,
    title: 'portfolio.training.title',
    description: 'portfolio.training.description',
  ...
  {
    id: 4,
    title: 'portfolio.biodiversity.title',
    description: 'portfolio.biodiversity.description',
